...
A imagem `assets/images/publications/philatelic-literature.png` foi gerada por IA com a ferramenta integrada `image_gen`, sem imagens de referência externas; representa livros e selos imaginários. O prompt e a utilização estão registados em [literature-image.md](literature-image.md).
